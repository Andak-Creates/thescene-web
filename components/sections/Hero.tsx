          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
            ...
            >
              ...
              <div className="flex flex-col items-start leading-[1.1] relative z-10 pt-0.5">
                <span className="text-[10px] sm:text-[11px] font-medium text-white/80 tracking-wide uppercase">
                  Download on the
                </span>
            ...
            >
              ...
              <div className="flex flex-col items-start leading-[1.1] relative z-10 pt-0.5">
                <span className="text-[10px] sm:text-[11px] font-medium text-white/70 tracking-wide uppercase">
                  GET IT ON
                </span>
                <span className="text-lg sm:text-xl font-semibold tracking-tight">
                  Google Play
