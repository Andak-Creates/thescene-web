...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-theme-bg/80 backdrop-blur-md border-b border-theme-border ${isScrolled ? "py-4" : "py-6"}`}
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <Link
          href="/"
          className="flex items-center h-10 overflow-hidden relative w-32"
          aria-label="TheScene"
        >
          <Image
