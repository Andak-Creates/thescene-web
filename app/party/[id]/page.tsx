...
export default async function PartyFallback({
  ...
  return (
    <main className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center relative overflow-hidden px-6">
      ...
      <div className="relative z-10 max-w-xl w-full text-center space-y-8 p-10 bg-white/5 border border-white/10 rounded-[2rem] backdrop-blur-md shadow-2xl">
        {/* Brand Icon / Party Icon */}
        <div className="mx-auto w-24 h-24 bg-gradient-to-br from-theme-purple to-purple-400 rounded-[1.5rem] flex items-center justify-center shadow-[0_0_40px_rgba(147,51,234,0.4)] mb-2 relative overflow-hidden group">
        ...
        <div className="pt-6 flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            className="flex items-center justify-center gap-4 px-8 py-4 bg-white/5 border border-white/20 rounded-2xl text-white hover:bg-white/10 hover:border-white/30 active:scale-95 transition-all duration-300 w-full sm:w-auto overflow-hidden group relative"
          >
            ...
            <svg viewBox="0 0 384 512" className="h-7 w-7 fill-current relative z-10" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/5 to-white/0 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"></div>
            <svg viewBox="0 0 512 512" className="h-7 w-7 fill-current relative z-10" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg">
